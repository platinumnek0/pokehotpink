...
#define FLAG_SHOW_SPEAKER_NAME 0x2F // shows the speaker's nameplate in textboxes
...
#define FLAG_PARTY_MOVES                     0x68  // used for the move relearner in the party menu
