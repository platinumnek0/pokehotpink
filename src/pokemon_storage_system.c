...
static void PrintDisplayMonInfo(void)
{
    ...
    if (sStorage->boxOption != OPTION_MOVE_ITEMS)
    {
        ...
        AddTextPrinterParameterized(WIN_DISPLAY_INFO, GetFontIdToFit(sStorage->displayMonSpeciesName, FONT_SHORT, 0, 9*8 - 12), sStorage->displayMonSpeciesName, 6, 15, TEXT_SKIP_DRAW, NULL);
