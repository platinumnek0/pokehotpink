...
{
    HOENN_TO_NATIONAL(CROCONUT),
    HOENN_TO_NATIONAL(TROPIDILE),
    HOENN_TO_NATIONAL(OILIGATOR),
    HOENN_TO_NATIONAL(SKRAPPUP),
    HOENN_TO_NATIONAL(HOTWEILER),
    HOENN_TO_NATIONAL(CERBERAWL),
    HOENN_TO_NATIONAL(KITFISK),
    HOENN_TO_NATIONAL(AMPURR),
    HOENN_TO_NATIONAL(PANTHUNDER),
    HOENN_TO_NATIONAL(RODERECT),
    HOENN_TO_NATIONAL(CHODENT),
    HOENN_TO_NATIONAL(MIMICHICK),
    HOENN_TO_NATIONAL(ACTERN),
    HOENN_TO_NATIONAL(DECEPTRICE),
    HOENN_TO_NATIONAL(SQWEEKLING),
    HOENN_TO_NATIONAL(CLAMORAT),
    HOENN_TO_NATIONAL(AZZALIEN),
    HOENN_TO_NATIONAL(WEEVICIOUS),
    HOENN_TO_NATIONAL(WEEVILLAIN),
    HOENN_TO_NATIONAL(SPIDIRT),
    HOENN_TO_NATIONAL(MARRANTULA),
    HOENN_TO_NATIONAL(CAONINE),
    HOENN_TO_NATIONAL(LUPENSA),
    HOENN_TO_NATIONAL(APATHOUND),
    HOENN_TO_NATIONAL(DENKOMORI),
    HOENN_TO_NATIONAL(OINKLET),
    HOENN_TO_NATIONAL(SPIGHOG),
    HOENN_TO_NATIONAL(MATROFFLE),
    HOENN_TO_NATIONAL(HAMFISTON),
    HOENN_TO_NATIONAL(SNAAM),
    HOENN_TO_NATIONAL(FRAAMOTH),
    HOENN_TO_NATIONAL(BENCHA),
    HOENN_TO_NATIONAL(BENCHAPPEARO),
    HOENN_TO_NATIONAL(ABINGRANIL),
    HOENN_TO_NATIONAL(SKUNGUS),
    HOENN_TO_NATIONAL(SKUNGROWTH),
    HOENN_TO_NATIONAL(INCHWYRM),
    HOENN_TO_NATIONAL(DRAKOON),
    HOENN_TO_NATIONAL(FLUTTERROR),
    HOENN_TO_NATIONAL(CREEPEAT),
    HOENN_TO_NATIONAL(SWAMPEAT),
    HOENN_TO_NATIONAL(SHELLITE),
    HOENN_TO_NATIONAL(SHELLOSSAL),
    HOENN_TO_NATIONAL(SALIVOLT),
    HOENN_TO_NATIONAL(MASTIDIC),
    HOENN_TO_NATIONAL(BORZY),
    HOENN_TO_NATIONAL(BORZYZY),
    HOENN_TO_NATIONAL(BORZYZYZY),
    HOENN_TO_NATIONAL(URSQUISH),
    HOENN_TO_NATIONAL(URSTRETCH),
    HOENN_TO_NATIONAL(URSTRONG),
    HOENN_TO_NATIONAL(PIKAGREEN),
    HOENN_TO_NATIONAL(PISCOLO),
    HOENN_TO_NATIONAL(PISCHOOL),
    HOENN_TO_NATIONAL(BALOOM),
    HOENN_TO_NATIONAL(COULRIMAR),
    HOENN_TO_NATIONAL(COOFOAL),
    HOENN_TO_NATIONAL(EQUAVIAN),
    HOENN_TO_NATIONAL(KATRED),
    HOENN_TO_NATIONAL(KATRIOL),
    HOENN_TO_NATIONAL(WILLYWOO),
    HOENN_TO_NATIONAL(WIRLYDOO),
    HOENN_TO_NATIONAL(CHOCLI),
    HOENN_TO_NATIONAL(CHOCLSTACK),
    HOENN_TO_NATIONAL(GINGECHOCL),
    HOENN_TO_NATIONAL(BUNBBLE),
    HOENN_TO_NATIONAL(USLUGGI),
    HOENN_TO_NATIONAL(GASTRABBOD),
    HOENN_TO_NATIONAL(SIGMANDER),
    HOENN_TO_NATIONAL(TADROSE),
    HOENN_TO_NATIONAL(RAVENUS),
    HOENN_TO_NATIONAL(GLUTTOAD),
    HOENN_TO_NATIONAL(DECAPYRE),
    HOENN_TO_NATIONAL(CRUSTEMPER),
    HOENN_TO_NATIONAL(CARCINERATE),
    HOENN_TO_NATIONAL(CAPYBUD),
    HOENN_TO_NATIONAL(CAPYDOZER),
    HOENN_TO_NATIONAL(BUMBLIN),
    HOENN_TO_NATIONAL(BUMBLECRUST),
    HOENN_TO_NATIONAL(CIXNO),
    HOENN_TO_NATIONAL(MAGPILE),
    HOENN_TO_NATIONAL(RAVENNUI),
    HOENN_TO_NATIONAL(PARECCUR),
    HOENN_TO_NATIONAL(PARERECCUR),
    HOENN_TO_NATIONAL(ICOPOD),
    HOENN_TO_NATIONAL(ICERRATE),
    HOENN_TO_NATIONAL(FLAKITTEN),
    HOENN_TO_NATIONAL(MANTIKUB),
    HOENN_TO_NATIONAL(ARKTIKORE),
    HOENN_TO_NATIONAL(MONKRAFT),
    HOENN_TO_NATIONAL(MONQI),
    HOENN_TO_NATIONAL(BAKRETE),
    HOENN_TO_NATIONAL(PASTRIFIED),
    HOENN_TO_NATIONAL(CHEFTONIC),
    HOENN_TO_NATIONAL(SMALLCRYO),
    HOENN_TO_NATIONAL(GLASHALMON),
    HOENN_TO_NATIONAL(CRYOZUNA),
    HOENN_TO_NATIONAL(GOTTUGA),
    HOENN_TO_NATIONAL(PURAZI),
    HOENN_TO_NATIONAL(ABURILADO),
    HOENN_TO_NATIONAL(SUSUWATARI),
    HOENN_TO_NATIONAL(TAKEYANO),
    HOENN_TO_NATIONAL(TAKEYUKI),
    HOENN_TO_NATIONAL(TEKTOHT),
    HOENN_TO_NATIONAL(TEKTAMERHA),
    HOENN_TO_NATIONAL(NIQIUTE),
    HOENN_TO_NATIONAL(NIQING),
    HOENN_TO_NATIONAL(TERUFAI),
    HOENN_TO_NATIONAL(PARASOUL),
    HOENN_TO_NATIONAL(HORROHORRA),
    HOENN_TO_NATIONAL(IGNIZARD),
    HOENN_TO_NATIONAL(DEMOLIZARD),
    HOENN_TO_NATIONAL(VOLTEON),
    HOENN_TO_NATIONAL(KOBOLEYE),
    HOENN_TO_NATIONAL(CHILICHICK),
    HOENN_TO_NATIONAL(HENSEAR),
    HOENN_TO_NATIONAL(PEEPLUMB),
    HOENN_TO_NATIONAL(ROTROCK),
    HOENN_TO_NATIONAL(ROTTYRANT),
    HOENN_TO_NATIONAL(SNIMP),
    HOENN_TO_NATIONAL(SNIMP2),
    HOENN_TO_NATIONAL(SNIMP3),
    HOENN_TO_NATIONAL(TRAPDOLLAR),
    HOENN_TO_NATIONAL(FIVEFISH),
    HOENN_TO_NATIONAL(BOWLDER),
    HOENN_TO_NATIONAL(CHARAMELLO),
    HOENN_TO_NATIONAL(DANSEAR),
    HOENN_TO_NATIONAL(LEAGULL),
    HOENN_TO_NATIONAL(COWPLANT),
    HOENN_TO_NATIONAL(MACHIGER),
    HOENN_TO_NATIONAL(PORCELYMPH),
    HOENN_TO_NATIONAL(IMAIGO),
    HOENN_TO_NATIONAL(VIVINSECT),
    HOENN_TO_NATIONAL(ZOMBONE),
    HOENN_TO_NATIONAL(ZOMBEAT),
    HOENN_TO_NATIONAL(LICKIBOO),
    HOENN_TO_NATIONAL(LICKILITHY),
    HOENN_TO_NATIONAL(BHIVER),
    HOENN_TO_NATIONAL(WHARID),
    HOENN_TO_NATIONAL(OWHASIS),
    HOENN_TO_NATIONAL(GLIRUB),
    HOENN_TO_NATIONAL(COLEOX),
    HOENN_TO_NATIONAL(DOZENCULUS),
    HOENN_TO_NATIONAL(CAPRALEO),
    HOENN_TO_NATIONAL(CAPRANCIEN),
    HOENN_TO_NATIONAL(ANOMBUS),
    HOENN_TO_NATIONAL(ANOTEM),
    HOENN_TO_NATIONAL(AMBERGHO),
    HOENN_TO_NATIONAL(LARCHAIE),
    HOENN_TO_NATIONAL(LHEROIQUE),
    HOENN_TO_NATIONAL(PUEBLET),
    HOENN_TO_NATIONAL(ABODOBE),
    HOENN_TO_NATIONAL(CASAGUARO),
    HOENN_TO_NATIONAL(COWBOY),
    HOENN_TO_NATIONAL(COWBOY2),
    HOENN_TO_NATIONAL(GUGOIYAS),
    HOENN_TO_NATIONAL(QILAMON),
    HOENN_TO_NATIONAL(QILAMON2),
    HOENN_TO_NATIONAL(DOZAI),
    HOENN_TO_NATIONAL(EASLUMBER),
    HOENN_TO_NATIONAL(JAKIKENDI),
    HOENN_TO_NATIONAL(JONFYRKENDI),
    HOENN_TO_NATIONAL(GRUBCAP),
    HOENN_TO_NATIONAL(CARAB),
    HOENN_TO_NATIONAL(DIVHORSE),
    HOENN_TO_NATIONAL(DROMEGERRY),
    HOENN_TO_NATIONAL(SGARRED),
    HOENN_TO_NATIONAL(GILLMONGER),
    HOENN_TO_NATIONAL(SQUALLYP),
    HOENN_TO_NATIONAL(CNITESKY),
    HOENN_TO_NATIONAL(PRISMANNAH),
    HOENN_TO_NATIONAL(FISCHERA),
    HOENN_TO_NATIONAL(CELASSTIAL),
    HOENN_TO_NATIONAL(MEKANIS),
    HOENN_TO_NATIONAL(MEKAMABOB),
    HOENN_TO_NATIONAL(MEKAMAJIG),
    HOENN_TO_NATIONAL(CRAYNIUM),
    HOENN_TO_NATIONAL(KINEKAST),
    HOENN_TO_NATIONAL(TELLUZION),
    HOENN_TO_NATIONAL(KNITWIT),
    HOENN_TO_NATIONAL(VALENTWINE),
    HOENN_TO_NATIONAL(DJEEODE),
    HOENN_TO_NATIONAL(DJEEODE2),
    HOENN_TO_NATIONAL(FURBUFF),
    HOENN_TO_NATIONAL(FRIGHTUFF),
    HOENN_TO_NATIONAL(KAHEAP),
    HOENN_TO_NATIONAL(KOOSGHOOS),
    HOENN_TO_NATIONAL(TRICKLESTER),
    HOENN_TO_NATIONAL(SKRAPBOY),
    HOENN_TO_NATIONAL(OOGIELUGG),
    HOENN_TO_NATIONAL(BADA_BANG),
    HOENN_TO_NATIONAL(BADA_BOOM),
    HOENN_TO_NATIONAL(GREITAHEER),
    HOENN_TO_NATIONAL(TRULIVURS),
    HOENN_TO_NATIONAL(DELICAUSTY),
    HOENN_TO_NATIONAL(WAXLET),
    HOENN_TO_NATIONAL(WAXTARDLY),
    HOENN_TO_NATIONAL(WAXTERMIND),
    HOENN_TO_NATIONAL(PFOTEWYRE),
    HOENN_TO_NATIONAL(CIRPITRII),
    HOENN_TO_NATIONAL(AMEWBA),
    HOENN_TO_NATIONAL(MEWKARYOTE),
    HOENN_TO_NATIONAL(SMHAUG),
    HOENN_TO_NATIONAL(OROBORING),
    HOENN_TO_NATIONAL(JIBJAB),
    HOENN_TO_NATIONAL(WACKERSNACK),
    HOENN_TO_NATIONAL(JIBBERWACKY),
    HOENN_TO_NATIONAL(RASKART),
    HOENN_TO_NATIONAL(SIMPSDON),
    HOENN_TO_NATIONAL(TINGTANG),
    HOENN_TO_NATIONAL(WALAWALA),
    ...
    HOENN_TO_NATIONAL(SWEWELL),
    HOENN_TO_NATIONAL(GEWEDRA),
    HOENN_TO_NATIONAL(BRAPBOON),
    HOENN_TO_NATIONAL(BARREEF),
    HOENN_TO_NATIONAL(CEPHELESTE),
    HOENN_TO_NATIONAL(ALGEIST),
    HOENN_TO_NATIONAL(FEAREST),
    HOENN_TO_NATIONAL(ARRENGAI),
    HOENN_TO_NATIONAL(BENGER),
    HOENN_TO_NATIONAL(BLASGER),
    HOENN_TO_NATIONAL(RAIGER),
    HOENN_TO_NATIONAL(JEWELGER),
    HOENN_TO_NATIONAL(GEISGER),
    HOENN_TO_NATIONAL(CREACHGER),
    HOENN_TO_NATIONAL(THRAUNE),
    HOENN_TO_NATIONAL(NACLERUB),
    HOENN_TO_NATIONAL(SERAHGIC),
    HOENN_TO_NATIONAL(RABURABU),
    HOENN_TO_NATIONAL(GLOOBO),
    HOENN_TO_NATIONAL(GLOOBO2),
    HOENN_TO_NATIONAL(GLOOBIATH),
    HOENN_TO_NATIONAL(MONSTIGUE),
    HOENN_TO_NATIONAL(CATIGUYST),
    HOENN_TO_NATIONAL(CATIGULYSM),
    HOENN_TO_NATIONAL(SLINIMOUS),
    HOENN_TO_NATIONAL(METAMAXI),
    HOENN_TO_NATIONAL(SLAXIMOUS),
    HOENN_TO_NATIONAL(ARIES),
    HOENN_TO_NATIONAL(GASLIGHT),
    HOENN_TO_NATIONAL(GATEKEEP),
    HOENN_TO_NATIONAL(GIRLBOSS),
    HOENN_TO_NATIONAL(GREGIGRIGA),
    HOENN_TO_NATIONAL(GLAZZLE),
    HOENN_TO_NATIONAL(IONO),
};
...
const u8 *GetSpeciesPokedexDescription(u16 species)
{
    ...
    if( (((gSaveBlock2Ptr->playerTrainerId[1] << 8) | gSaveBlock2Ptr->playerTrainerId[0]) % 2) == 0)
    {
    ...
    {
        if (gSpeciesInfo[species].description2 == NULL)
            return gSpeciesInfo[SPECIES_NONE].description;
        else
            return gSpeciesInfo[species].description2;
    }
}
        ...
        for (i = 0; evolutions[i].method != EVOLUTIONS_END; i++)
        {
            ...
            case EVO_MOVE_THREE_SEGMENT:
                if (MonKnowsMove(mon, evolutions[i].param) && (personality % 100) == 0)
                    targetSpecies = evolutions[i].targetSpecies;
                break;
            case EVO_LEVEL_COMMON:
                if (evolutions[i].param <= level && (personality % 100) != 0  && (GetMonAbility(mon) != ABILITY_GOOEY))
                    targetSpecies = evolutions[i].targetSpecies;
                break;
            case EVO_LEVEL_EPIC:
                if (evolutions[i].param <= level && (personality % 100) == 0  && (GetMonAbility(mon) != ABILITY_GOOEY))
                    targetSpecies = evolutions[i].targetSpecies;
                break;
            case EVO_ABILITY_EPIC:
                if ((evolutions[i].param <= level) && (GetMonAbility(mon) == ABILITY_GOOEY))
                    targetSpecies = evolutions[i].targetSpecies;
                break;
            ...
            case EVO_ITEM_HOLD:
                ...
                break;
            case EVO_KO_10_TIMES_WITH_SLASHING_MOVES:
                if (evolutionTracker >= 10 && level >= evolutions[i].param)
                    targetSpecies = evolutions[i].targetSpecies;
                break;
            case EVO_LEVEL_MOVE_TEN_TIMES:
                if (evolutionTracker >= 10)
                    targetSpecies = evolutions[i].targetSpecies;
                break;
            case EVO_LEVEL_MOVE_TWENTY_TIMES:
            case EVO_MOVE_20_TIMES_ON_GRASS_TYPES:
