...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
	...
	HOENN_TO_NATIONAL(CAPYBRAH),
	HOENN_TO_NATIONAL(CAPYBERIC),
	...
	HOENN_TO_NATIONAL(TAKASANE),
	HOENN_TO_NATIONAL(TAKINEI),
	...
	HOENN_TO_NATIONAL(CACTOT),
	HOENN_TO_NATIONAL(CACTERRA),
	HOENN_TO_NATIONAL(COWBOY1),
	...
	HOENN_TO_NATIONAL(ROSWHELP),
	HOENN_TO_NATIONAL(VIENHANHA),
	...
	HOENN_TO_NATIONAL(SLACK2),
	HOENN_TO_NATIONAL(SLAXIMOUS),
	HOENN_TO_NATIONAL(ARIES),
	HOENN_TO_NATIONAL(GREGIPHALT),
	HOENN_TO_NATIONAL(GREGIPRIDE),
	HOENN_TO_NATIONAL(GREGITROUT),
	...
	HOENN_TO_NATIONAL(ELUCYON),
	HOENN_TO_NATIONAL(I0NO),
