...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(PORKID),
    HOENN_TO_NATIONAL(PIGOT),
    HOENN_TO_NATIONAL(HOGEST),
    ...
    HOENN_TO_NATIONAL(CAKELSTACK),
    HOENN_TO_NATIONAL(GINGENACL),
