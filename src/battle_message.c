...
static const u8 sText_OvergrowActivated[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Grass\nmoves grow stronger!");
static const u8 sText_BlazeActivated[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Fire\nmoves grow stronger!");
static const u8 sText_TorrentActivated[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Water\nmoves grow stronger!");
static const u8 sText_SwarmActivated[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Bug\nmoves grow stronger!");
