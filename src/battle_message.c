...
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} had the idea for\na new move: {B_BUFF2}.\p");
static const u8 sText_TryToLearnMove2[] = _("But, {B_BUFF1} can't learn\nmore than four moves.\p");
static const u8 sText_TryToLearnMove3[] = _("Should a move be replaced\nwith {B_BUFF2}?");
...
static const u8 sText_PkmnChargingPower[] = _("{B_ATK_NAME_WITH_PREFIX} is\ncharging up power!");
...
static const u8 sText_PkmnShroudedItself[] = _("{B_ATK_NAME_WITH_PREFIX} shrouded itself\nand its ally in {B_CURRENT_MOVE}!");
static const u8 sText_PkmnMoveBounced[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE}\nwas bounced back by the magic coating!");
...
static const u8 sText_ElectricTerrainEnds[] = _("The electric current on the\nbattlefield faded.");
static const u8 sText_MistyTerrainEnds[] = _("The mist cleared from\nthe battlefield.");
static const u8 sText_PsychicTerrainEnds[] = _("The weirdness dissipated\nfrom the battlefield.");
static const u8 sText_GrassyTerrainEnds[] = _("The overgrowth disappeared\nfrom the battlefield.");
...
static const u8 sText_MoldBreakerEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} breaks through\nfoes' abilities!");
...
static const u8 sText_SlowStartEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is taking it slow…");
static const u8 sText_SlowStartEnd[] = _("{B_ATK_NAME_WITH_PREFIX} leapt into\naction!");
...
static const u8 sText_TerrainBecomesGrassy[] = _("Lush flora grew to cover\nthe battlefield!");
...
static const u8 sText_ElectricTerrainPreventsSleep[] = _("{B_DEF_NAME_WITH_PREFIX} is kept awake by\nthe electric terrain!");
static const u8 sText_PsychicTerrainPreventsPriority[] = _("{B_DEF_NAME_WITH_PREFIX} is protected\nby psychic power!");
static const u8 sText_SafetyGogglesProtected[] = _("{B_DEF_NAME_WITH_PREFIX} is not affected\nthanks to its {B_LAST_ITEM}!");
static const u8 sText_FlowerVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX} is protected\nby law!");
...
static const u8 sText_MeteorBeamCharging[] = _("{B_ATK_NAME_WITH_PREFIX} is absorbing\ncosmic energy!");
...
static const u8 sText_StockpiledEffectWoreOff[] = _("{B_ATK_NAME_WITH_PREFIX}'s stockpile\ncounter fell to {B_BUFF1}!");
...
static const u8 sText_TargetCoveredInStickyCandySyrup[] = _("{B_DEF_NAME_WITH_PREFIX} was covered\nin sticky candy syrup!");
...
static const u8 sText_MoltedNoStatus[] = _("{B_ATK_NAME_WITH_PREFIX} didn't have\nany status to clear…");
static const u8 sText_ShedItsSkin[] = _("{B_ATK_NAME_WITH_PREFIX} shed its\nskin and reset its stats!");
static const u8 sText_PkmnTrappedHollowWhirl[] = _("{B_DEF_NAME_WITH_PREFIX} was trapped\nby spirits!");
static const u8 sText_OvergrowActivated[] = _("{B_DEF_NAME_WITH_PREFIX}'s Grass\nmoves grow stronger!");
static const u8 sText_BlazeActivated[] = _("{B_DEF_NAME_WITH_PREFIX}'s Fire\nmoves grow stronger!");
...
static const u8 sText_OvergrowActivatedAttacker[] = _("{B_ATK_NAME_WITH_PREFIX}'s Grass\nmoves grow stronger!");
...
static const u8 sText_PkmnCanEvolve[] = _("{B_BUFF1} is able\nto evolve!{WAIT_SE}\p");
...
static const u8 sText_ChargeCountRose[] = _("{B_ATK_NAME_WITH_PREFIX}'s Charge\nlevel rose to {B_BUFF3}!");
static const u8 sText_ChargeCountLeft[] = _("{B_ATK_NAME_WITH_PREFIX} has {B_BUFF3}\nCharges left!");
static const u8 sText_LostCharge[] = _("{B_ATK_NAME_WITH_PREFIX}'s\nCharge flickered out!");
static const u8 sText_ChargeCountFell[] = _("{B_ATK_NAME_WITH_PREFIX}'s Charge level\nfell to {B_BUFF3}!");
static const u8 sText_DefChargeCountRose[] = _("{B_DEF_NAME_WITH_PREFIX}'s Charge level\nrose to {B_BUFF3}!");
static const u8 sText_ParriedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} parried\n{B_ATK_NAME_WITH_PREFIX}'s attack!");
static const u8 sText_TookParryStance[] = _("{B_ATK_NAME_WITH_PREFIX} took a defensive\nstance!");
static const u8 sText_CursedBodyTormented[] = _("{B_ATK_NAME_WITH_PREFIX} was subjected\nto torment by {B_DEF_NAME_WITH_PREFIX}'s\l{B_DEF_ABILITY}!");
static const u8 sText_PkmnStartedToPanic[] = _("{B_DEF_NAME_WITH_PREFIX} started to\npanic and use more PP!");
static const u8 sText_TargetWasMinimizedByItem[] = _("{B_DEF_NAME_WITH_PREFIX} was shrunken\ndown by {B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ITEM}!");
...
static const u8 sText_MagicCoatWoreOff[] = _("{B_ATK_NAME_WITH_PREFIX}'s magic coating\nwore off!");
static const u8 sText_TargetCoveredInSlowtons[] = _("{B_DEF_NAME_WITH_PREFIX} was covered\nin slowton particles!");

const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    [STRINGID_TARGETCOVEREDINSLOWTONS - BATTLESTRINGS_TABLE_START] = sText_TargetCoveredInSlowtons,
    [STRINGID_PKMNUSEDX - BATTLESTRINGS_TABLE_START] = sText_AttackerUsedX,
    [STRINGID_MAGICCOATWOREOFF - BATTLESTRINGS_TABLE_START] = sText_MagicCoatWoreOff,
    ...
    [STRINGID_TARGETMINIMIZED - BATTLESTRINGS_TABLE_START] = sText_TargetWasMinimized,
    [STRINGID_STARTEDTOPANIC - BATTLESTRINGS_TABLE_START] = sText_PkmnStartedToPanic,
    [STRINGID_CURSEDBODYTORMENTED - BATTLESTRINGS_TABLE_START] = sText_CursedBodyTormented,
    [STRINGID_TOOKPARRYSTANCE - BATTLESTRINGS_TABLE_START] = sText_TookParryStance,
    [STRINGID_PARRIEDATTACK - BATTLESTRINGS_TABLE_START] = sText_ParriedAttack,
    ...
    [STRINGID_CHARGECOUNTLEFT - BATTLESTRINGS_TABLE_START] = sText_ChargeCountLeft,
    ...
    [STRINGID_OVERGROWACTIVATEDATTACKER - BATTLESTRINGS_TABLE_START] = sText_SwarmActivatedAttacker,
    ...
    [STRINGID_SWARMACTIVATED - BATTLESTRINGS_TABLE_START] = sText_SwarmActivated,
    [STRINGID_TORRENTACTIVATED - BATTLESTRINGS_TABLE_START] = sText_TorrentActivated,
    [STRINGID_BLAZEACTIVATED - BATTLESTRINGS_TABLE_START] = sText_BlazeActivated,
    [STRINGID_OVERGROWACTIVATED - BATTLESTRINGS_TABLE_START] = sText_OvergrowActivated,
    [STRINGID_PKMNCUTSSPATKWITH - BATTLESTRINGS_TABLE_START] = sText_PkmnCutsSpAtkWith,
    [STRINGID_HOLLOWWHIRLTRAPPED - BATTLESTRINGS_TABLE_START] = sText_PkmnTrappedHollowWhirl,
    [STRINGID_MOLTED - BATTLESTRINGS_TABLE_START] = sText_ShedItsSkin,
    [STRINGID_MOLTEDNOSTATUS - BATTLESTRINGS_TABLE_START] = sText_MoltedNoStatus,
...
const u16 gMissStringIds[] =
{
    ...
    [B_MSG_PARRIED] = STRINGID_PARRIEDATTACK
};
