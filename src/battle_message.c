...
static const u8 sText_ParriedAttack[] = _("{B_ATK_NAME_WITH_PREFIX} parried\n{B_DEF_NAME_WITH_PREFIX}'s attack!");
static const u8 sText_ParryFailed[] = _("The parry failed!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PARRYFAILED - BATTLESTRINGS_TABLE_START] = sText_ParryFailed,
