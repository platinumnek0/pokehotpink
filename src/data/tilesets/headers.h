...
const struct Tileset gTileset_Asterra =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Asterra,
    .palettes = gTilesetPalettes_Asterra,
    .metatiles = gMetatiles_Asterra,
...
const struct Tileset gTileset_Hamborough =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Hamborough,
    .palettes = gTilesetPalettes_Hamborough,
    .metatiles = gMetatiles_Hamborough,
    .metatileAttributes = gMetatileAttributes_Hamborough,
    .callback = NULL,
};
