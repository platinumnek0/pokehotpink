...
const struct BattleMoveEffect gBattleMoveEffects[NUM_BATTLE_MOVE_EFFECTS] =
{
    ...
    [EFFECT_HOLISTICS] =
    {
        .battleScript = BattleScript_EffectHolistics,
        .battleTvScore = 0, // TODO: Assign points
    },
    ...
    [EFFECT_DETECT] =
    {
        .battleScript = BattleScript_EffectDetect,
        .battleTvScore = 0, // TODO: Assign points
    },

    [EFFECT_SPATK_SPDEF_DOWN] =
    {
        .battleScript = BattleScript_EffectEerieImpulse,
        .battleTvScore = 0, // TODO: Assign points
    },
};
