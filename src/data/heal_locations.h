static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_BEASTON - 1] = {MAP_GROUP(BEASTON), MAP_NUM(BEASTON), 30, 25},
    [HEAL_LOCATION_PORKBELLY - 1] = {MAP_GROUP(PORKBELLY), MAP_NUM(PORKBELLY), 28, 36},
    [HEAL_LOCATION_ASTERRA_WITH_HEALSPOT - 1] = {MAP_GROUP(ASTERRA_WITH_HEALSPOT), MAP_NUM(ASTERRA_WITH_HEALSPOT), 28, 6},
    [HEAL_LOCATION_HAMBOROUGH - 1] = {MAP_GROUP(HAMBOROUGH), MAP_NUM(HAMBOROUGH), 17, 18},
};
