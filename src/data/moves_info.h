...
static const u8 sHeavySlamDescription[] = _(
    "Does more damage the heavier the\n"
    "user is, compared to the target.");
...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "A 2-turn attack. High critical-\n"
            "hit chance. Charges instantly\n"
            "in Tailwind & removes it."),
    ...
    [MOVE_WRAP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Tangles the foe in long, stretchy\n"
            "appendages for "BINDING_TURNS" turns."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_RUBBER,
        .accuracy = 100,
    ...
    [MOVE_MIST] =
    {
        ...
        .description = COMPOUND_STRING(
            "Shrouds the user and its ally in\n"
            "a mist that blocks stat drops and\n"
            "weakens super-effective damage."),
        .effect = EFFECT_MIST,
        .power = 0,
        .type = TYPE_ICE,
        .accuracy = 0,
    ...
    [MOVE_AURORA_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that may lower Attack. In Hail,\n"
            "always lowers the foe's Attack."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_ICE,
        .accuracy = 100,
    ...
    [MOVE_DRAGON_RAGE] =
    {
        .name = COMPOUND_STRING("Fury"),
        .description = COMPOUND_STRING(
            "Attacks with a shockwave of\n"
            "pure anger."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_DRAGON,
    ...
    [MOVE_FISSURE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Splits the earth under the\n"
            "foe. High critical-hit chance."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_EGG_BOMB] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hurls an egg that explodes\n"
            "to hurt adjacent foes."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_DRAGON,
        .accuracy = 80,
    ...
    [MOVE_WATERFALL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "speed & may flinch. Out of\n"
            "battle, can climb waterfalls."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_SKULL_BASH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Raises Defense the first turn,\n"
            "then attacks the second."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 130,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_TRIPLE_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "Kicks the foe 3 times, doing more\n"
            "damage with each kick."),
    ...
    [MOVE_SPIDER_WEB] =
    {
        ...
        .description = COMPOUND_STRING(
            "Traps the foe in a silk web to\n"
            "lower its Speed and prevent\n"
    ...
    [MOVE_AEROBLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            "Batters the foe with a mini\n"
            "tornado. Hits flying foes."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_OCTAZOOKA] =
    {
        .name = COMPOUND_STRING("Ink Cloud"),
        .description = COMPOUND_STRING(
            "Fires a lump of ink to\n"
            "damage. May cut accuracy."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_GIGA_DRAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Drains the target's energy,\n"
            "healing the user for half the\n"
            "damage dealt."),
        .effect = EFFECT_ABSORB,
        .power = 80,
        .type = TYPE_GRASS,
    ...
    [MOVE_FALSE_SWIPE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Leaves the foe with 1 HP. Hits\n"
            "Ghosts and gets stronger at\n"
            "high levels."),
    ...
    [MOVE_SAFEGUARD] =
    {
        ...
        .description = COMPOUND_STRING(
            "For 5 turns, foes can't inflict\n"
            "status conditions like Burn,\n"
            "Freeze, Taunt, or Infatuation."),
    ...
    [MOVE_DRAGON_BREATH] =
    {
        .name = COMPOUND_STRING("Drakesbreath"),
        .description = COMPOUND_STRING(
            "Strikes the foe with mystic\n"
            "energy. May paralyze."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DRAGON,
    ...
    [MOVE_RAPID_SPIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Spinning tackle that clears\n"
            "hazards and boost Speed."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_PSYCH_UP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Copies all the foe's stat\n"
            "changes over to the user."),
    ...
    [MOVE_CHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Electric move used. Stacks up to\n"
            "3, loses 1 when attacking."),
    ...
    [MOVE_WEATHER_BALL] =
    {
        ...
        .description = COMPOUND_STRING(
            "An attack that's stronger in\n"
            "weathers and changes its type\n"
            "to match."),
    ...
    [MOVE_AIR_CUTTER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Slices foes with sharp wind. High\n"
            "critical-hit ratio. Stronger in\n"
            "Tailwind."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_FLYING,
    ...
    [MOVE_SIGNAL_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Fires a strange beam of light\n"
            "that may confuse the foe. Lowers\n"
            "confused foes' Sp. Attack."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_BUG,
        .accuracy = 90,
    ...
    [MOVE_DRAGON_RUSH] =
    {
        .name = COMPOUND_STRING("Siege Rush"),
        .description = COMPOUND_STRING(
            "Charges like storming a\n"
            "castle. Breaks barriers."),
        .effect = EFFECT_BRICK_BREAK,
        .power = 80,
        .type = TYPE_DRAGON,
        .accuracy = 90,
    ...
    [MOVE_EARTH_POWER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Erupts the ground with power.\n"
            "May lower Sp. Def. In a Sandstorm,\n"
            "prevents healing for 3 turns."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_THUNDER_FANG] =
    {
        .name = COMPOUND_STRING("Kilo Bite"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_FANG] =
    {
        .name = COMPOUND_STRING("Blizz Bite"),
        .description = COMPOUND_STRING(
            "May cause flinching or\n"
            "frostbite."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_FIRE_FANG] =
    {
        .name = COMPOUND_STRING("Blaze Bite"),
        .description = COMPOUND_STRING(
            "May cause flinching or\n"
    ...
    [MOVE_DEFOG] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lowers the foe's Evasion. Clears\n"
            "all hazards and the foe's screens\n"
            "and Tailwind."),
        .effect = EFFECT_DEFOG,
        .power = 0,
        .type = TYPE_FLYING,
    ...
    [MOVE_CROSS_POISON] =
    {
        .name = COMPOUND_STRING("Toxic Slash"),
        .description = COMPOUND_STRING(
            "A slash that may poison.\n"
            "High critical-hit chance."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_POISON,
    ...
    [MOVE_WIDE_GUARD] =
    {
        ...
        .description = COMPOUND_STRING(
            "For one turn, blocks all\n"
            "incoming multi-target moves &\n"
            "slightly lowers direct damage."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_ROCK,
        .accuracy = 0,
    ...
    [MOVE_QUICK_GUARD] =
    {
        ...
        .description = COMPOUND_STRING(
            "For one turn, blocks all\n"
            "incoming priority moves and\n"
            "slightly reduces direct damage."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
    ...
    [MOVE_BULLDOZE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Stomps down on the ground to cut\n"
            "Speed and destroy terrain.\n"
            "Stronger if terrain is active."),
    ...
    [MOVE_DRAGON_TAIL] =
    {
        ...
        .description = COMPOUND_STRING(
            "A tail sweep that knocks the\n"
            "target away and drags out another\n"
    ...
    [MOVE_ELECTROWEB] =
    {
        ...
        .description = COMPOUND_STRING(
            "Snares both foes in an electric\n"
            "net to lower their Speed."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_CRAFTY_SHIELD] =
    {
        ...
        .description = COMPOUND_STRING(
            "For one turn, blocks all\n"
            "incoming status moves targeting\n"
    ...
    [MOVE_GRASSY_TERRAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "restoring HP for grounded Pokémon\n"
            "for 5 turns."),
    ...
    [MOVE_DIAMOND_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Whips up a storm of diamonds to\n"
            "slice the foes. May boost the\n"
            "user's Defense."),
        .power = 100,
        .type = TYPE_ROCK,
        .accuracy = 90,
    ...
    [MOVE_SPIKY_SHIELD] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Hurts any foes that make contact."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 0,
    ...
    [MOVE_BANEFUL_BUNKER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "all incoming moves and poisons\n"
    ...
    [MOVE_DARKEST_LARIAT] =
    {
        ...
        .description = COMPOUND_STRING(
            "A brutal spinning arm swing.\n"
            "Ignores the foe's Defense and\n"
            "Evasion boosts."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_DARK,
    ...
    [MOVE_SPARKLING_ARIA] =
    {
        ...
        .description = COMPOUND_STRING(
            "An elegant song amidst a sea\n"
            "of bubbles. Heals burns for any\n"
            "Pokémon hit."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_WATER,
    ...
    [MOVE_LUNGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lunges at the foe and may\n"
            "lower its Attack stat."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_DRAGON_HAMMER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Slams the user's whole body into\n"
            "the foe. This lowers the user's\n"
            "Speed."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_DRAGON,
    ...
    [MOVE_SHADOW_BONE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Clubs the foe with a ghastly\n"
            "bone that may lowers its Defense."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_OVERDRIVE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A resonant shockwave charged\n"
            "with electricity. In Static\n"
            "Terrain, ignores stat changes."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_OBSTRUCT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Takes a defensive stance to\n"
            "protect from damage. Harshly\n"
            "lowers Defense on contact."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    [MOVE_GRASSY_GLIDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to tackle the foe. Goes first in\n"
            "Lush Terrain."),
    ...
    [MOVE_JUNGLE_HEALING] =
    {
        ...
        .description = COMPOUND_STRING(
            "With the power of nature, heals\n"
            "itself and its ally's HP and\n"
            "status. Heals more if poisoned."),
    ...
    [MOVE_FIERY_WRATH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks with hate, stronger\n"
            "if the user is suffering."),
        .effect = EFFECT_FACADE,
        .power = 70,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_GLACIAL_LANCE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "foe. May cause frostbite. In Hail,\n"
            "lowers the foe's Defense."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_ICE,
    ...
    [MOVE_BARB_BARRAGE] =
    {
        .name = COMPOUND_STRING("Barb Charge"),
        .description = COMPOUND_STRING(
            "May poison. Stronger on\n"
            "poisoned foes."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = 60,
        .type = TYPE_POISON,
    ...
    [MOVE_BITTER_MALICE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Stronger on foes with statuses."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = 60,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical hit ratio; may flinch\n"
            "or lower the foe's Defense."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_INFERNAL_PARADE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Phantom flames scorch both foes.\n"
            "Stronger on foes with status\n"
            "conditions. May leave a burn."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = 60,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_BLEAKWIND_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may cause frostbite. Doesn't\n"
            "miss and may freeze in Hail."),
    ...
    [MOVE_SANDSEAR_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A scorching gust of arid wind that\n"
            "may burn. Never misses in a\n"
            "sandstorm."),
    ...
    [MOVE_SILK_TRAP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Spins a silken trap to protect\n"
            "from damage and lower the Speed\n"
            "of foes who make contact."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_BUG,
        .accuracy = 0,
    ...
    [MOVE_SPIN_OUT] =
    {
        ...
        .description = COMPOUND_STRING(
            "A furious spinning attack.\n"
            "Harshly cuts user's Speed."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_ICE_SPINNER] =
    {
        ...
        .description = COMPOUND_STRING(
            "A graceful yet deadly twirl,\n"
            "damaging the foe and removing\n"
    ...
    [MOVE_FLOWER_TRICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "An explosive flower that never\n"
            "misses and has a high critical\n"
            "hit ratio."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_GRASS,
    ...
    [MOVE_RAGING_BULL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "barriers. This move changes its\n"
            "type to match the user's."),
        .effect = EFFECT_REVELATION_DANCE,
        .power = 90,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_CHILLING_WATER] =
    {
        .name = COMPOUND_STRING("Chill Douse"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYDRO_STEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Blastes boiling water that's\n"
            "stronger in harsh sun."),
    ...
    [MOVE_ELECTRO_SHOT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Doesn't need to charge in Rain."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 130,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_TACHYON_CUTTER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Slices with lightspeed\n"
            "particles and hits first."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_ALLURING_VOICE] =
    {
        .name = COMPOUND_STRING("Angel Voice"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEAR] =
    {
        .name = COMPOUND_STRING("Sear"),
        .description = COMPOUND_STRING(
            "Smacks the foe with a\n"
            "scorching limb. May burn."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_ENERGY_BURST] =
    {
        .name = COMPOUND_STRING("Energy Burst"),
        .description = COMPOUND_STRING(
        "Attacks with a burst of pure\n"
        "energy."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_NORMAL,
    ...
    {
        .name = COMPOUND_STRING("0º Bullets"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MOLT] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user sheds its skin to\n"
            "clear stat changes & status.\n"
            "Can't be used twice in a row."),
        .effect = EFFECT_MOLT,
        .power = 0,
        .type = TYPE_BUG,
    ...
    [MOVE_SPIKE_JAB] =
    {
        .name = COMPOUND_STRING("Spike Jab"),
        .description = COMPOUND_STRING(
            "Stabs the foe with a sharp\n"
            "spike or edge."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_CLOD_LOB] =
    {
        .name = COMPOUND_STRING("Clod Lob"),
        .description = COMPOUND_STRING(
            "Hurls a clump of dirt at\n"
            "the foe."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GROUND,
    ...
    [MOVE_BRACE] =
    {
        .name = COMPOUND_STRING("Brace"),
        .description = COMPOUND_STRING(
            "Prepares for a blow and\n"
            "boosts Sp.Def."),
    ...
    [MOVE_STARE] =
    {
        .name = COMPOUND_STRING("Stare"),
        .description = COMPOUND_STRING(
            "An unnerving gaze that\n"
            "cuts the foe's Sp.Def."),
    ...
    [MOVE_GOO_GLOB] =
    {
        .name = COMPOUND_STRING("Goo Glob"),
        .description = COMPOUND_STRING(
            "Hurls strange, rubbery\n"
            "goop at the foe."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_RUBBER,
    ...
    [MOVE_HOLLOW_BOOM] =
    {
        .name = COMPOUND_STRING("Hollow Boom"),
        .description = COMPOUND_STRING(
            "A ghastly explosion.\n"
            "High critical-hit chance."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_GHASTLY_HAZE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that may cause frostbite. Lowers\n"
            "Sp.Atk in Tailwind."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_GHOST,
    ...
    [MOVE_NEWTON_TACKLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Stronger the higher the user's\n"
            "Speed is."),
    ...
    [MOVE_SCORCH] =
    {
        .name = COMPOUND_STRING("Scorch"),
        .description = COMPOUND_STRING(
            "A spark of fire leaves the\n"
            "foe with a burn."),
        .effect = EFFECT_WILL_O_WISP,
        .power = 0,
        .type = TYPE_FIRE,
    ...
    [MOVE_METAL_GNAW] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user gnaws on the foe,\n"
            "healing half the damage dealt\n"
            "and hitting flying foes."),
        .effect = EFFECT_ABSORB,
        .power = 80,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_BURNING_RUBBER] =
    {
        .name = COMPOUND_STRING("Burning Rubber"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WHITE_NOISE] = 
    {
        ...
        .description = COMPOUND_STRING(
            "Surrounds the foe with an odd\n"
            "sound wave that may confuse it.\n"
            "Drops confused foes' Sp. Defense."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_SNOT_ROCKET] =
    {
        .name = COMPOUND_STRING("Snot Rocket"),
        .description = COMPOUND_STRING(
            "Spits mucus and spreads any\n"
            "status problem to the foe."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_POISON,
        .accuracy = 100,
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SPREAD_USER_STATUS,
            .chance = 100,
        }),
    },
    ...
    [MOVE_PRIMORDIAL_PULSE] =
    {
        ...
        .effect = EFFECT_PRIMORDIAL_PULSE,
        .power = 85,
        .type = TYPE_ROCK,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_PONDER] =
    {
        .name = COMPOUND_STRING("Ponder"),
        .description = COMPOUND_STRING(
            "Stops to think, raises\n"
            "Sp.Atk."),
    ...
    [MOVE_SUBZERO_SLAM] =
    {
        .name = COMPOUND_STRING("Subzero Slam"),
        .description = COMPOUND_STRING(
            "Charges at the foe like a\n"
            "glacier. This hurts the user."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_ICE,
        .accuracy = 85,
    ...
    [MOVE_HYDRA_STRIKE] =
    {
        .name = COMPOUND_STRING("Hydra Strike"),
        .description = COMPOUND_STRING(
            "A three-strike attack that\n"
            "gets stronger each hit."),
        .effect = EFFECT_TRIPLE_KICK,
        .power = 30,
        .type = TYPE_DRAGON,
        .accuracy = 90,
    ...
    [MOVE_WYRMWIND] =
    {
        .name = COMPOUND_STRING("Wyrmwind"),
        .description = COMPOUND_STRING(
            "A mystic wind that may boost\n"
            "the user's Sp.Atk."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_DRAGON,
    ...
    [MOVE_ALCHEMAR] =
    {
        .name = COMPOUND_STRING("Alchemar"),
        .description = COMPOUND_STRING(
            "Attacks with a mystic fire\n"
            "that may burn."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_DRAGON,
    ...
    [MOVE_NOBLE_LUNGE] =
    {
        .name = COMPOUND_STRING("Noble Lunge"),
        .description = COMPOUND_STRING(
            "A swift, elegant strike.\n"
            "High critical-hit chance."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_DRAGON,
    ...
    [MOVE_DEVASTATION] =
    {
        .name = COMPOUND_STRING("Devastation"),
        .description = COMPOUND_STRING(
            "An intense attack that leaves\n"
            "the user immobile after."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_DRAGON,
        .accuracy = 85,
    ...
    [MOVE_MALAURA] =
    {
        .name = COMPOUND_STRING("Malaura"),
        .description = COMPOUND_STRING(
            "A sinister pulse that may\n"
            "flinch."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_DARK,
    ...
    [MOVE_SQUEAL] =
    {
        .name = COMPOUND_STRING("Squeal"),
        .description = COMPOUND_STRING(
            "A sharp shriek that may cause\n"
            "flinching."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_DARK,
    ...
    [MOVE_SINGLE_BLOW] =
    {
        .name = COMPOUND_STRING("Single BLow"),
        .description = COMPOUND_STRING(
            "Never misses, but goes last."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    [MOVE_ABYSSAL_PULL] =
    {
        .name = COMPOUND_STRING("Abyssal Pull"),
        .description = COMPOUND_STRING(
            "Snares the foe in a dark void\n"
            "to prevent escape."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_DARK,
    ...
    [MOVE_BIFF] =
    {
        .name = COMPOUND_STRING("Biff"),
        .description = COMPOUND_STRING(
            "Playfully smacks the foe."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FAIRY,
        .accuracy = 100,
    ...
    [MOVE_SUGAR_RUSH] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user quickly charges at\n"
            "the foe, always going first."),
        .effect = EFFECT_HIT,
        .power = 45,
        .type = TYPE_FAIRY,
        .accuracy = 100,
    ...
    [MOVE_MOONGLOW] =
    {
        .name = COMPOUND_STRING("Moonglow"),
        .description = COMPOUND_STRING(
            "A blast of light that may\n"
            "lower Sp.Def."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_FAIRY,
    ...
    [MOVE_PLAY_TAG] =
    {
        .name = COMPOUND_STRING("Play Tag"),
        .description = COMPOUND_STRING(
            "Playfully attacks, then\n"
            "switches with an ally."),
        .effect = EFFECT_HIT_ESCAPE,
        .power = 70,
        .type = TYPE_FAIRY,
        .accuracy = 100,
    ...
    [MOVE_RUBBER_LASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A quick stretchy slap that lowers\n"
            "the foe's Defense."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_RUBBER,
    ...
    [MOVE_WARBLE] =
    {
        .name = COMPOUND_STRING("Warble"),
        .description = COMPOUND_STRING(
            "A resonant twang that damages\n"
            "foes."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_RUBBER,
    ...
    [MOVE_SKEDADDLE] =
    {
        .name = COMPOUND_STRING("Skedaddle"),
        .description = COMPOUND_STRING(
            "Attacks, then flees to switch\n"
            "with an ally."),
        .effect = EFFECT_HIT_ESCAPE,
        .power = 80,
        .type = TYPE_RUBBER,
    ...
    [MOVE_SPRING_BASH] =
    {
        .name = COMPOUND_STRING("Spring Bash"),
        .description = COMPOUND_STRING(
            "Bounces up, then down the\n"
            "next turn. May paralyze."),
        .effect = EFFECT_SEMI_INVULNERABLE,
    ...
    [MOVE_WALLOP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Smacks the foe hard over the head.\n"
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_RUBBER,
    ...
    [MOVE_DONUTS] =
    {
        .name = COMPOUND_STRING("Donuts"),
        .description = COMPOUND_STRING(
            "Spins wildly, hitting every-\n"
            "one. User becomes confused."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_RUBBER,
        .accuracy = 90,
    ...
    [MOVE_GLUE_BIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "Traps the foe with sticky glue\n"
            "to prevent escape and lower\n"
            "Speed."),
        .effect = EFFECT_TRAP_LOWER_SPEED,
        .power = 0,
        .type = TYPE_RUBBER,
    ...
    [MOVE_REVERBERATE] =
    {
        ...
        .description = COMPOUND_STRING(
            "If another sound move was used\n"
            "earlier in the turn, this move's\n"
            "power increases."),
    ...
    [MOVE_SCRUB_CLEAN] =
    {
        .name = COMPOUND_STRING("Scrub Clean"),
        .description = COMPOUND_STRING(
            "Washes away the target's stat\n"
            "changes. Restores HP if used on\n"
            "an ally instead."),
        .effect = EFFECT_HIT_ENEMY_HEAL_ALLY,
        .power = 50,
        .type = TYPE_WATER,
    ...
    [MOVE_TRANSMUTE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Goes first & changes the foe's\n"
            "type, making it weak to the\n"
            "user's last attack."),
    ...
    [MOVE_MIST_BOMB] =
    {
        .name = COMPOUND_STRING("Mist Bomb"),
        .description = COMPOUND_STRING(
            "The user fires a ball of packed\n"
            "mist at the foe that becomes\n"
            "stronger in misty terrain."),
        .effect = EFFECT_MIST_BOMB,
        .power = 70,
        .type = TYPE_FAIRY,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_BARRIER_CRASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Stronger for each barrier on the\n"
            "battlefield. Breaks down all\n"
            "barriers."),
