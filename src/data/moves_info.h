...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_SHADOW_PUNCH] =
    {
        .name = COMPOUND_STRING("Polterpunch"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_CLAW] =
    {
        .name = COMPOUND_STRING("Specter Claw"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHARGE_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Fires electricity. Boosts\n"
            "Speed with leftover charge."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_DRAGON_HAMMER] =
    {
        .name = COMPOUND_STRING("Arcane Hammer"),
        .description = COMPOUND_STRING(
            "Slams its whole body into the\n"
            "foe. This hurts the user."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_DRAGON,
        .accuracy = 90,
    ...
    [MOVE_BITTER_MALICE] =
    {
        .name = COMPOUND_STRING("Bitter Hate"),
        .description = COMPOUND_STRING(
            "Stronger if the user is hit\n"
            "before attacking."),
        .effect = EFFECT_PAYBACK,
        .power = 60,
        .type = TYPE_GHOST,
    ...
    [MOVE_CINDER_SLIDE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A burning tackle that goes first\n"
