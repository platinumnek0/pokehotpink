...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_KARATE_CHOP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "and precise chop that has a\n"
            "high chance of landing critical\n"
            "hits."),
        .effect = EFFECT_HIT,
        .power = 45,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_GUILLOTINE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "jaws or pincers that may lower\n"
            "its Defense."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_BUG,
    ...
    [MOVE_SONIC_BOOM] =
    {
        ...
        .description = COMPOUND_STRING(
            "The foe is damaged with a quick,\n"
            "violent burst of sound."),
        .effect = EFFECT_HIT,
        .power = 45,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_SLEEP_POWDER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the target, lulling it to sleep."),
        .effect = EFFECT_SLEEP,
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 75,
    ...
    [MOVE_THUNDER_SHOCK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A small electrical shock attack\n"
    ...
    [MOVE_FISSURE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "violently in two. This attack has\n"
            "a high chance of landing a\n"
            "critical hit."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_GROUND,
    ...
    [MOVE_METRONOME] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "every move a Pokémon can learn."),
    ...
    [MOVE_CRABHAMMER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "strong pincer. This move has a\n"
            "high chance of landing a\n"
            "critical hit."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_WATER,
    ...
    [MOVE_TRIPLE_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "The foe is kicked thrice in\n"
            "rapid succession, with each\n"
            "kick dealing greater damage\n"
            "than the last."),
    ...
    [MOVE_DESTINY_BOND] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "user faints, so does the Pokémon\n"
            "that knocked it out."),
    ...
    [MOVE_CROSS_CHOP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "shape. This move has a high chance\n"
            "of landing a critical hit."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIGHTING,
