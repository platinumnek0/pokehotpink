...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_FLY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "of battle, this move can be used\n"
            "to travel to any known location."),
    ...
    [MOVE_GROWTH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Sp. Atk stats. In harsh sunlight,\n"
            "these stats are sharply boosted."),
    ...
    [MOVE_THUNDER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "misses. It may paralyze the foe."),
    ...
    [MOVE_FISSURE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "likely to land a critical hit and\n"
            "hits foes that are underground."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_TOXIC] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "into the foe. The longer the foe\n"
            "is poisoned for, the more damage\n"
            "it takes at the end of the turn."),
        .effect = EFFECT_TOXIC,
        .power = 0,
        .type = TYPE_POISON,
        .accuracy = 80,
    ...
    [MOVE_FIRE_BLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "intense, all-engulfing fire.\n"
            "This may leave the foe with a\n"
            "burn."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FIRE,
    ...
    [MOVE_BUBBLE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "sprayed at the foe. This may\n"
            "lower the foe's Speed as well."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_SHARPEN] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user sharpens rough edges\n"
            "on its body, raising its Attack\n"
            "and Accuracy."),
    ...
    [MOVE_SPITE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Channeling its hatred, the user\n"
            "deducts 4 PP from whichever move\n"
            "the target last used."),
        .effect = EFFECT_SPITE,
        .power = 0,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_PROTECT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "incoming attacks. The more this\n"
            "move is used, the more it fails-\n"
            "especially if used successively."),
    ...
    [MOVE_ENDEAVOR] =
    {
        ...
        .description = COMPOUND_STRING(
            "This move always cuts down the\n"
            "target's HP so that it's exactly\n"
            "equal to whatever the user's\n"
            "current HP is."),
    ...
    [MOVE_CALM_MIND] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "meditating to raise its Special\n"
    ...
    [MOVE_HEART_SWAP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the user swaps all of its stat\n"
            "changes with those of the\n"
            "target."),
    ...
    [MOVE_NASTY_PLOT] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user sharply raises its\n"
            "Special Attack by devising\n"
            "dastardly tricks and schemes."),
        .effect = EFFECT_SPECIAL_ATTACK_UP_2,
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    [MOVE_TRICK_ROOM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "slower Pokémon move before faster\n"
            "ones."),
    ...
    [MOVE_DRACO_METEOR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lowers the user's Special Attack."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_DISCHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Pokémon on the battlefield. This\n"
    ...
    [MOVE_SEED_FLARE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lower the foe's Special Defense."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_GRASS,
        .accuracy = 85,
    ...
    [MOVE_SLUDGE_WAVE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "wave of vile sludge. Any Pokémon\n"
    ...
    [MOVE_ECHOED_VOICE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "turn any Pokémon in battle uses\n"
    ...
    [MOVE_STRUGGLE_BUG] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lowers both foes' Special Attack."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SNARL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "them and lowering their Special\n"
            "Attack."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_DARK,
    ...
    {
        .name = COMPOUND_STRING("Power Drain"),
        .description = COMPOUND_STRING(
            "All surrounding Pokémon are\n"
    ...
    [MOVE_FAIRY_LOCK] = //do something else with
    {
    ...
    [MOVE_KINGS_SHIELD] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user protects itself from\n"
            "incoming attacks. Any battler\n"
            "that makes contact with the user\n"
            "has its Attack lowered."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_STEEL,
        .accuracy = 0,
    ...
    [MOVE_CONFIDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "focus and lowering its Special\n"
            "Attack."),
    ...
    [MOVE_AROMATIC_MIST] =
    {
        ...
        .description = COMPOUND_STRING(
            "A soothing aroma boosts Special\n"
            "Defense for the user and its\n"
            "ally."),
    ...
    [MOVE_EERIE_IMPULSE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("EerieImpulse", "Eerie Pulse"),
        .description = COMPOUND_STRING(
            "The target is exposed to a\n"
            "strange, unsettling radio wave\n"
            "that unnerves it and lowers its\n"
            "Sp. Atk and Sp. Def."),
        .effect = EFFECT_SPATK_SPDEF_DOWN,
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = 90,
        .pp = 15,
    ...
    [MOVE_VENOM_DRENCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Any poisoned foes are drenched\n"
            "in a strange liquid that lowers\n"
            "their Attack, Special Attack, and\n"
            "Speed."),
    ...
    [MOVE_MAGNETIC_FLUX] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "boost Defense and Special Defense\n"
            "for the user or ally if they're\n"
            "Charged."),
    ...
    [MOVE_LANDS_WRATH] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user draws energy from the\n"
            "earth to attack both foes."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("Mountain Blades"),
        .description = COMPOUND_STRING(
            "Both foes are attacked with\n"
            "jagged blades made from stone\n"
            "and soil."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_GROUND,
    ...
    [MOVE_BANEFUL_BUNKER] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user protects itself from\n"
            "all incoming moves. Any Pokémon\n"
            "that makes contact with the user\n"
            "will be poisoned."),
        .effect = EFFECT_PROTECT,
        .power = 0,
    ...
    [MOVE_GEAR_UP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Power-generating gears spin to\n"
            "boost Attack and Special Attack\n"
            "for the user or ally if they're\n"
            "Charged."),
    ...
    [MOVE_BRUTAL_SWING] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "body around, damaging all Pokémon\n"
            "around it."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_DARK,
    ...
    [MOVE_FLEUR_CANNON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "sharply lowers the user's Special\n"
            "Attack."),
        .effect = EFFECT_HIT,
        .power = 130,
        .type = TYPE_FAIRY,
    ...
    {
        .name = COMPOUND_STRING("Stomping Fit"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MOONGEIST_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "The foe is blasted with a beam of\n"
            "dark lunar energy that completely\n"
            "ignores its Ability."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_GHOST,
    ...
    [MOVE_TEARFUL_LOOK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lowering its Attack and Special\n"
            "Attack."),
        .effect = EFFECT_NOBLE_ROAR,
        .power = 0,
        .type = TYPE_NORMAL,
    ...
    {
        .name = COMPOUND_STRING("Iron Bash"),
        .description = COMPOUND_STRING(
            "The foe is bashed with steel-\n"
            "hard fists twice in a row.\n"
            "Each hit may make the foe\n"
            "flinch."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_STEEL,
    ...
    [MOVE_SNIPE_SHOT] =
    {
        ...
        .description = COMPOUND_STRING(
            "This move never misses, ignores\n"
            "any and all redirection, and is\n"
            "likely to land a critical hit."),
    ...
    [MOVE_MAGIC_POWDER] = //give some other effect
    {
    ...
    [MOVE_TEATIME] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "take a time-out for a quick\n"
            "snack break, eating any Berries\n"
            "they may be holding."),
    ...
    [MOVE_OCTOLOCK] =
    {
        ...
        .description = COMPOUND_STRING(
            "The foe is trapped with binding\n"
            "tentacles that lower its Defense\n"
            "and Special Defense each turn."),
    ...
    [MOVE_BODY_PRESS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "uses the user's Defense to deal\n"
            "damage instead of its Attack."),
    ...
    [MOVE_METEOR_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its Special Attack. On the second\n"
            "turn, the user attacks."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 120,
        .type = TYPE_ROCK,
        .accuracy = 90,
    ...
    [MOVE_SKITTER_SMACK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "and lowering its Special Attack."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_JUNGLE_HEALING] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its ally. Poisoned Pokémon have\n"
            "more of their HP restored."),
    ...
    [MOVE_SILK_TRAP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Pokémon that makes contact with\n"
    ...
    [MOVE_GLAIVE_RUSH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its might. Afterwards, the user\n"
            "can't evade attacks and takes\n"
    ...
    [MOVE_SALT_CURE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "take more damage from these\n"
            "salts than other Pokémon."),
    ...
    [MOVE_FILLET_AWAY] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user loses half of its\n"
            "maximum HP, but sharply boosts\n"
            "its Attack, Special Attack, and\n"
            "Speed."),
    ...
    [MOVE_MAKE_IT_RAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Foes are pelted with gold coins.\n"
            "This lowers the user's Special\n"
            "Attack. Money is earned after\n"
            "the battle."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_STEEL,
    ...
    [MOVE_COMEUPPANCE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Whichever battler last hit the\n"
            "user is hit back for twice the\n"
            "damage it inflicted."),
        .effect = EFFECT_METAL_BURST,
        .power = 1,
        .type = TYPE_DARK,
    ...
    [MOVE_BLAZING_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user revs up and charges at\n"
            "the foe, cloaked in flames. This\n"
            "may leave the foe with a burn."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
    ...
    [MOVE_MAGICAL_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user revs up and charges at\n"
            "the foe, cloaked in a mystic\n"
            "energy. This may leave the target\n"
            "confused."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FAIRY,
    ...
    [MOVE_IVY_CUDGEL] =
    {
        .name = COMPOUND_STRING("Ivy Club"),
        .description = COMPOUND_STRING(
            "The foe is clubbed hard with a\n"
            "thick, knotted vine. This move\n"
            "is likely to land a critical\n"
            "hit."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_GRASS,
    ...
    [MOVE_TACHYON_CUTTER] =
    {
        ...
        .description = COMPOUND_STRING(
            "The foe is sliced with particles\n"
            "faster than light. This move hits\n"
    ...
    [MOVE_TEMPER_FLARE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "out and attacks. This move's\n"
            "power doubles if the user's last\n"
            "move missed or failed."),
        .effect = EFFECT_STOMPING_TANTRUM,
        .power = 75,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_MALIGNANT_CHAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "The foe is wrapped tightly in a\n"
            "rusty, corrosive chain. This move\n"
            "is likely to leave the foe badly\n"
            "poisoned."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_POISON,
    ...
    [MOVE_RICOCHET] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user bounces around, hitting\n"
            "the foe 2 to 5 times. This move\n"
            "becomes stronger for each Speed\n"
            "boost the user has."),
    ...
    [MOVE_ZERO_DEGREE_BULLETS] = 
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "If used in a hailstorm, the\n"
            "chance to freeze increases."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_ICE,
        .accuracy = 90,
    ...
    [MOVE_SHARPSHOOT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Dis shot nevah misses da tahget.\n"
            "It breaks through all da foe's\n"
            "protection too."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_STEEL,
    ...
    [MOVE_SLOW_SLOW_BEAM] =
    {
        ...
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SLOW_SLOW_BEAM,
            .chance = 100,
        }),
    },
    ...
    [MOVE_HOLLOW_GUARD] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "from all incoming attacks. Any\n"
            "battler that makes contact will\n"
            "have its Attack sharply lowered."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_GHOST,
        .accuracy = 0,
    ...
    [MOVE_GHASTLY_HAZE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Both foes are enveloped in a\n"
            "ghostly fog that may leave them\n"
            "with frostbite."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_GHOST,
    ...
    [MOVE_BACKSTAB] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "user, this move becomes stronger,\n"
    ...
    [MOVE_DUST_DEVIL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "able to hit airborne foes,\n"
            "ignoring their Ground immunities."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_BEFUDDLE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lower the foe's Special Attack."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_CYNICIZE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "one that ignores the Pokémon's\n"
            "stat boosts."),
