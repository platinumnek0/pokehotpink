...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_STOMP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Stomps hard and may flinch the\n"
            "foe. This move is stronger on\n"
            "Bug-types."),
    ...
    [MOVE_POISON_JAB] =
    {
        .name = COMPOUND_STRING("Venomash"),
        .description = COMPOUND_STRING(
            "A bashing attack that\n"
            "may poison the foe."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_POISON,
    ...
    [MOVE_DRAGON_HAMMER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the foe. This sharply lowers the\n"
            "user's Speed."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_DRAGON,
    ...
    [MOVE_EXPANDING_FORCE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "both foes and gets stronger on\n"
            "psychic terrain."),
    ...
    [MOVE_GRASSY_GLIDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to tackle the foe. Goes first on\n"
            "lush terrain."),
    ...
    [MOVE_ICE_SPINNER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Twirls and slams into the\n"
            "foe, destroying any terrain."),
        .effect = EFFECT_HIT_SET_REMOVE_TERRAIN,
        .power = 80,
        .type = TYPE_ICE,
        .accuracy = 100,
    ...
    [MOVE_JET_STREAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A violent air current. May\n"
            "boost the user's Speed."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_NUTBOLT] = 
    {
        ...
        .description = COMPOUND_STRING(
            "The user blasts rusty metal\n"
            "at the foe and may poison it,\n"
            "even Poison- & Steel-types."),
    ...
    [MOVE_TRANSMUTE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Alchemically changes the foe's\n"
