...
const u8 gText_ThisIsAPokemon[] = _("As a researcher, you will be given a\n"
                                    "partner Pokémon like so to assist with\l"
                                    "field work.{PAUSE 96}\p");
...
const u8 gText_DexNatTitle[] = _("Expanded Dex");
const u8 gText_DexSortNumericalTitle[] = _("Numerical");
const u8 gText_DexSortAtoZTitle[] = _("A-to-Z");
const u8 gText_DexSortHeaviestTitle[] = _("Heavy-to-Light");
const u8 gText_DexSortLightestTitle[] = _("Light-to-heavy");
const u8 gText_DexSortTallestTitle[] = _("Tall-to-small");
const u8 gText_DexSortSmallestTitle[] = _("Small-to-tall");
...
const u8 gText_DexHoennDescription[] = _("Gagil region's Pokédex");
const u8 gText_DexNatDescription[] = _("Gagil expanded Pokédex");
const u8 gText_DexSortNumericalDescription[] = _("Pokémon are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Seen and owned Pokémon are listed\nalphabetically.");
...
const u8 gMenuText_Check[] = _("Chekc");
...
const u8 gText_DadsAdvice[] = _("There's a time and place for\neverything…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnNeedsToReplaceMove[] = _("{STR_VAR_1} had an idea for a\nnew move: {STR_VAR_2}.\pShould a move be replaced with\n{STR_VAR_2}?");
const u8 gText_StopLearningMove2[] = _("Stop trying to teach\n{STR_VAR_2}?");
const u8 gText_MoveNotLearned[] = _("{STR_VAR_1} did not learn the\nmove {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_WhichMoveToForget[] = _("Which move should be replaced?{PAUSE_UNTIL_PRESS}");
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_2} was removed from\n{STR_VAR_1}'s moves.\pAnd…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NextLv[] = _("Exp. to next Lv.");
...
const u8 gText_LanettesPC[] = _("Amber'S PC");
...
const u8 gPCText_PolkaDot[] = _("Polka-Dor");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Gagil region.");
...
const u8 gText_NoTrainersRegistered[] = _("No TRAINERS are Pokémon."); // Unused
...
const u8 gText_PokenavMap_ZoomedOutButtons[] = _("{B_BUTTON} Exit Map");
...
const u8 gText_ContinueMenuPokedex[] = _("Pokémon");
...
const u8 gText_DexHoenn[] = _("Gagil");
const u8 gText_DexNational[] = _("Expanded");
...
const u8 gText_MoveRelearnerPkmnTryingToLearnMove[] = _("Delete a current move to make\nroom for {STR_VAR_2}?");
...
const u8 gText_MoveRelearnerPkmnForgotMoveAndLearnedNew[] = _("{STR_VAR_3} was replaced\nwith {STR_VAR_2}.");
...
const u8 gText_FieldMoveSelection[] = _("Field Moves");
const u8 gText_ChooseFieldMove[] = _("Use which move?");
