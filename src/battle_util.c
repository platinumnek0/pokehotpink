...
void HandleAction_UseMove(void)
{
        ...
        && GetBattlerSide(gBattlerAttacker) != GetBattlerSide(gSideTimers[side].followmeTarget))
    {
        gBattleStruct->moveTarget[gBattlerAttacker] = gBattlerTarget = gSideTimers[side].followmeTarget; // follow me moxie fix
           ...
           && ((GetBattlerAbility(*(gBattleStruct->moveTarget + gBattlerAttacker)) != ABILITY_LIGHTNING_ROD && moveType == TYPE_ELECTRIC)
            ...
            || (GetBattlerAbility(*(gBattleStruct->moveTarget + gBattlerAttacker)) != ABILITY_FLYTRAP && moveType == TYPE_BUG)))
    {
        ...
        for (battler = 0; battler < gBattlersCount; battler++)
        {
            if (side != GetBattlerSide(battler)
                ...
                && ((GetBattlerAbility(battler) == ABILITY_LIGHTNING_ROD && moveType == TYPE_ELECTRIC)
                 ...
                 || (GetBattlerAbility(battler) == ABILITY_FLASH_FIRE && moveType == TYPE_FIRE)
                 || (GetBattlerAbility(battler) == ABILITY_FLYTRAP && moveType == TYPE_BUG))
        ...
        else
        {
            ...
            else if (battlerAbility == ABILITY_FLYTRAP)
                gSpecialStatuses[battler].flytrapRedirected = TRUE;
    ...
    //set the sound move flag if a sound move was chosen
    if (gMovesInfo[gChosenMove].soundMove && gMovesInfo[gChosenMove].effect != EFFECT_REVERBERATE)
    {
        gProtectStructs[gBattlerAttacker].usedSoundMove = TRUE;
    }
...
static const u8 sHoldEffectToType[][2] =
{
    ...
    {HOLD_EFFECT_RUBBER_POWER, TYPE_RUBBER},
};
...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Rubber
    ...
    [TYPE_FIGHTING] = {X(2.0), ______, X(0.5), X(0.5), ______, X(2.0), X(0.5), X(0.0), X(2.0), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), X(0.5), X(0.5)}, //fighting
    [TYPE_FLYING]   = {______, X(2.0), ______, ______, ______, X(0.5), X(2.0), ______, X(0.5), ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, ______, ______}, //flying
    [TYPE_POISON]   = {______, ______, ______, X(0.5), X(0.5), X(0.5), ______, X(0.5), X(0.0), ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), X(0.5)}, //poison
    [TYPE_GROUND]   = {______, ______, X(0.0), X(2.0), ______, X(2.0), X(0.5), ______, X(2.0), ______, X(2.0), ______, X(0.5), X(2.0), ______, X(0.5), ______, ______, ______, ______}, //ground
    [TYPE_ROCK]     = {______, X(0.5), X(2.0), ______, X(0.5), ______, X(2.0), ______, X(0.5), ______, X(2.0), ______, ______, ______, ______, X(2.0), ______, ______, ______, ______}, //rock
    [TYPE_BUG]      = {______, X(0.5), X(0.5), X(0.5), ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), ______, ______}, //bug
#if B_STEEL_RESISTANCES >= GEN_6
    [TYPE_GHOST]    = {X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______, ______}, //ghost
#else
    [TYPE_GHOST]    = {X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______, ______}, //old ghost
#endif
    [TYPE_STEEL]    = {______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, ______, X(2.0), X(2.0)}, //steel
    [TYPE_MYSTERY]  = {______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______}, //null
    [TYPE_FIRE]     = {______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(2.0), X(0.5), ______, ______, ______}, //fire
    [TYPE_WATER]    = {______, ______, ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), X(0.5), ______, ______, X(0.5)}, //water
    [TYPE_GRASS]    = {______, ______, X(0.5), X(0.5), X(2.0), X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), X(0.5), ______, ______, ______, X(0.5), ______, ______, X(2.0)}, //grass
    [TYPE_ELECTRIC] = {______, ______, X(2.0), ______, X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), ______, ______, X(0.5)}, //electric
    [TYPE_PSYCHIC]  = {______, X(2.0), ______, X(2.0), ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______, X(2.0)}, //psychic
    [TYPE_ICE]      = {______, ______, X(2.0), ______, X(2.0), ______, ______, ______, X(0.5), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(0.5), X(2.0), ______, ______, ______}, //ice
    [TYPE_DRAGON]   = {______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, X(2.0), ______, X(0.5), ______}, //dragon
#if B_STEEL_RESISTANCES >= GEN_6
    [TYPE_DARK]     = {______, X(0.5), ______, ______, ______, ______, X(0.5), X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5), ______}, //dark
#else
    [TYPE_DARK]     = {______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5), ______}, //old dark
#endif
    [TYPE_FAIRY]    = {______, X(2.0), ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, X(0.5), ______, X(2.0), X(2.0), ______, X(0.5)}, //fairy
    [TYPE_RUBBER]   = {______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.5), ______, ______, ______, ______, X(2.0), ______, X(0.5), ______, ______, X(2.0), ______}  //rubber
};
...
void PrepareStringBattle(u16 stringId, u32 battler)
{
              ...
              && !(gBattleScripting.stickyWebStatDrop == 1 && gSideTimers[targetSide].stickyWebBattlerSide == targetSide)) // Sticky Web must have been set by the foe
    {
        ...
        if (targetAbility == ABILITY_DEFIANT)
            gBattlescriptCurrInstr = BattleScript_DefiantRaiseAttack;
        else
            gBattlescriptCurrInstr = BattleScript_CompetitiveRaiseSpAtk;
        /*
        if (targetAbility == ABILITY_DEFIANT)
...
static bool32 IsGravityPreventingMove(u32 battler, u32 move)
{
    if (!(gFieldStatuses & STATUS_FIELD_GRAVITY))
        return FALSE;
    if(GetBattlerAbility(battler) == ABILITY_QUANTUM_SHIFT)
        return FALSE;
...
u32 TrySetCantSelectMoveBattleScript(u32 battler)
{
    ...
    if (DYNAMAX_BYPASS_CHECK && gBattleStruct->zmove.toBeUsed[gBattlerAttacker] == MOVE_NONE && IsGravityPreventingMove(gBattlerAttacker, move))
    {
        gCurrentMove = move;
        if (gBattleTypeFlags & BATTLE_TYPE_PALACE)
        {
...
u8 CheckMoveLimitations(u32 battler, u8 unusableMoves, u16 check)
{
    ...
    for (i = 0; i < MAX_MON_MOVES; i++)
    {
        ...
        // Assault Vest
            ...
            unusableMoves |= gBitTable[i];
        // Gravity
        else if (check & MOVE_LIMITATION_GRAVITY && IsGravityPreventingMove(battler, move))
            unusableMoves |= gBitTable[i];
        // Heal Block
    ...
    while (gBattleStruct->turnEffectsBattlerId < gBattlersCount && gBattleStruct->turnEffectsTracker <= ENDTURN_BATTLER_COUNT)
    {
        ...
        case ENDTURN_CHARGE:  // charge
            if (gDisableStructs[battler].chargeTimer > 0)
            {
                ...
                {
                    BattleScriptExecute(BattleScript_ChargeCountLeft);
                    effect++;
                }
            }
            gBattleStruct->turnEffectsTracker++;
        ...
        case ENDTURN_YAWN:  // yawn
            if (gStatuses3[battler] & STATUS3_YAWN)
            {
                ...
                if (!(gStatuses3[battler] & STATUS3_YAWN) && !(gBattleMons[battler].status1 & STATUS1_ANY)
                 ...
                 && battlerAbility != ABILITY_BAD_DREAMS
...
void TryClearRageAndFuryCutter(void)
{
    ...
    for (i = 0; i < gBattlersCount; i++)
    {
        ...
        if (gDisableStructs[i].furyCutterCounter != 0
        && (gMovesInfo[gChosenMoveByBattler[i]].effect != EFFECT_FURY_CUTTER
        || (gMovesInfo[gChosenMoveByBattler[i]].effect == EFFECT_FURY_CUTTER && gLastMoves[i] != gChosenMoveByBattler[i])))
...
u8 AtkCanceller_UnableToUseMove(u32 moveType)
{
    ...
    do
    {
        ...
        case CANCELLER_ASLEEP: // check being asleep
            if (gBattleMons[gBattlerAttacker].status1 & STATUS1_SLEEP)
            {
                ...
                else
                {
                    ...
                    if (gBattleMons[gBattlerAttacker].status1 & STATUS1_SLEEP)
                    {
                        if (gMovesInfo[gChosenMove].effect != EFFECT_SNORE && gChosenMove != MOVE_SLEEP_TALK)
                        {
        ...
        case CANCELLER_GRAVITY:
            if (gFieldStatuses & STATUS_FIELD_GRAVITY && IsGravityPreventingMove(gBattlerAttacker, gCurrentMove))
            {
...
// recursion boosts consecutively-hitting moves by 20% for each hit
static inline uq4_12_t GetRecursionModifier(u32 battler)
{
    return UQ_4_12(1.0) + (UQ_4_12(0.2) * gDisableStructs[battler].recursionCounter);
}

static inline uq4_12_t GetChargeModifier(u32 battler)
{
    return UQ_4_12(1.5) + (UQ_4_12(1.0) * gDisableStructs[battler].chargeTimer);
}
...
u32 AbilityBattleEffects(u32 caseID, u32 battler, u32 ability, u32 special, u32 moveArg)
{
    ...
    case ABILITYEFFECT_ON_SWITCHIN: // 0
        ...
        case ABILITY_UNNERVE:
            ...
            break;
        case ABILITY_UNSETTLE:
            if (!gSpecialStatuses[battler].switchInAbilityDone)
            {
                gBattlerAttacker = battler;
                gSpecialStatuses[battler].switchInAbilityDone = TRUE;
                SET_STATCHANGER(STAT_SPATK, 1, TRUE);
                BattleScriptPushCursorAndCallback(BattleScript_UnsettleActivates);
                effect++;
            }
            break;
        ...
        case ABILITY_INTREPID_SWORD:
            ...
            break;
        case ABILITY_COSMIC_AURA:
            i = GetHighestStatId(battler);
            if (!gSpecialStatuses[battler].switchInAbilityDone
            && CompareStat(battler, i, MAX_STAT_STAGE, CMP_LESS_THAN)
            && !(gBattleStruct->intrepidSwordBoost[GetBattlerSide(battler)] & gBitTable[gBattlerPartyIndexes[battler]]))
            {
                gBattleScripting.savedBattler = gBattlerAttacker;
                gBattlerAttacker = battler;
                ...
                BattleScriptPushCursorAndCallback(BattleScript_UserAndAllyStatBoost);
                effect++;
            }
            break;
        ...
        case ABILITY_RENEW:
            ...
            if (!gSpecialStatuses[battler].switchInAbilityDone
             && GetMonData(mon, MON_DATA_SPECIES) == SPECIES_OROBORING_MOBIUS
             && !(gBattleStruct->transformZeroToHero[side] & gBitTable[gBattlerPartyIndexes[battler]]))
            {
                gSpecialStatuses[battler].switchInAbilityDone = TRUE;
                gBattleStruct->transformZeroToHero[side] |= gBitTable[gBattlerPartyIndexes[battler]];
                BattleScriptPushCursorAndCallback(BattleScript_RenewActivates);
                effect++;
            }
            break;
    ...
    case ABILITYEFFECT_MOVES_BLOCK: // 2
        {
            ...
            if ((gLastUsedAbility == ABILITY_SOUNDPROOF && gMovesInfo[move].soundMove && !(moveTarget & MOVE_TARGET_USER))
             || (gLastUsedAbility == ABILITY_BULLETPROOF && gMovesInfo[move].ballisticMove) || (gLastUsedAbility == ABILITY_SIGHTLESS && gMovesInfo[move].lightMove))
            {
        ...
        if (move != MOVE_NONE)
        {
            ...
            case ABILITY_TOXIC_BOOST:
                if (moveType == TYPE_POISON && gMovesInfo[move].target != MOVE_TARGET_ALL_BATTLERS
                    && gBattleMons[gBattlerTarget].status1 & (STATUS1_POISON | STATUS1_TOXIC_POISON | STATUS1_TOXIC_COUNTER))
                    effect = 1;
                break;
            }
    ...
    case ABILITYEFFECT_MOVE_END: // Think contact abilities.
        ...
        case ABILITY_CURSED_BODY:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && (Random() % 10) < 3)
            {
                if((Random() % 3 != 0) && gDisableStructs[gBattlerAttacker].disabledMove == MOVE_NONE
                ...
                else if ((Random() % 3 == 0) && !(GetBattlerAbility(gBattlerAttacker) == ABILITY_OBLIVIOUS))
                {
                    gBattleMons[gBattlerAttacker].status2 |= STATUS2_TORMENT;
                    gDisableStructs[gBattlerAttacker].tormentTimer = PERMANENT_TORMENT; // permanent
                    BattleScriptPushCursor();
                    gBattlescriptCurrInstr = BattleScript_CursedBodyTorments;
                }
                effect++;
            }
            break;
        ...
        case ABILITY_ANGER_POINT:
            ...
            {
                if(CompareStat(battler, STAT_ATK, MAX_STAT_STAGE, CMP_LESS_THAN) && (gIsCriticalHit || CalcTypeEffectivenessMultiplier(move, moveType, battler, gBattlerTarget, GetBattlerAbility(gBattlerTarget), FALSE) >= UQ_4_12(2.0)))
                {
                    gEffectBattler = battler;
                    SET_STATCHANGER(STAT_ATK, 1, FALSE);
                    BattleScriptPushCursor();
            ...
            break;
         case ABILITY_BOIL_OVER:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT) && TARGET_TURN_DAMAGED && IsBattlerAlive(battler))
            {
                if(CompareStat(battler, STAT_SPATK, MAX_STAT_STAGE, CMP_LESS_THAN) && (gIsCriticalHit || CalcTypeEffectivenessMultiplier(move, moveType, battler, gBattlerTarget, GetBattlerAbility(gBattlerTarget), FALSE) >= UQ_4_12(2.0)))
                {
                    gEffectBattler = battler;
                    SET_STATCHANGER(STAT_SPATK, 1, FALSE);
                    BattleScriptPushCursor();
        ...
        case ABILITY_TANGLING_HAIR:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             && gBattleMons[gBattlerAttacker].hp != 0
             && ((CompareStat(gBattlerAttacker, STAT_SPEED, MIN_STAT_STAGE, CMP_GREATER_THAN) && (CompareStat(gBattlerAttacker, STAT_EVASION, MIN_STAT_STAGE, CMP_GREATER_THAN)))
            ...
            {
                PREPARE_ABILITY_BUFFER(gBattleTextBuff1, gLastUsedAbility);
                gBattleScripting.moveEffect = MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_SPEED_EVASION_DOWN;
                BattleScriptPushCursor();
        ...
        case ABILITY_MOLDY:
            ...
            {
                gBattleScripting.moveEffect = MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_HEAL_BLOCK_3_TURNS;
                PREPARE_ABILITY_BUFFER(gBattleTextBuff1, gLastUsedAbility);
                BattleScriptPushCursor();
                gBattlescriptCurrInstr = BattleScript_AbilityStatusEffect;
                gHitMarker |= HITMARKER_STATUS_ABILITY_EFFECT;
        ...
        case ABILITY_ELECTROMORPHOSIS:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && TARGET_TURN_DAMAGED
             && IsBattlerAlive(gBattlerTarget)
             && gDisableStructs[gBattlerTarget].chargeTimer < 3)
            {
                BattleScriptPushCursor();
    ...
    case ABILITYEFFECT_MOVE_END_ATTACKER: // Same as above, but for attacker
        ...
        case ABILITY_DEMOLITIONIST:
            if(IsBattlerAboveOneTenthHP(gBattlerAttacker)
            && !gProtectStructs[gBattlerAttacker].confusionSelfDmg
            && gMovesInfo[move].effect == EFFECT_EXPLOSION)
            {
                ...
                PREPARE_ABILITY_BUFFER(gBattleTextBuff1, gLastUsedAbility);
                BattleScriptPushCursor();
                gBattlescriptCurrInstr = BattleScript_DemolitionistActivates;
                effect++;
            }
            break;
        ...
        case ABILITY_DRAGONS_MAW:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && ((Random() % 5) == 0)
             && TARGET_TURN_DAMAGED
             && gMovesInfo[gCurrentMove].type == TYPE_DRAGON
             && !MoveHasAdditionalEffect(gCurrentMove, MOVE_EFFECT_FLINCH))
            {
                gBattleScripting.moveEffect = MOVE_EFFECT_FLINCH;
                PREPARE_ABILITY_BUFFER(gBattleTextBuff1, gLastUsedAbility);
        ...
        case ABILITY_GULP_MISSILE:
            ...
            break;
        case ABILITY_RECURSION:
            if(!(gMoveResultFlags & (MOVE_RESULT_FAILED | MOVE_RESULT_DOESNT_AFFECT_FOE | MOVE_RESULT_MISSED)) && move == gLastMoves[battler])
            {
                if(gDisableStructs[gBattlerAttacker].recursionCounter < 5)
                {
                    gDisableStructs[gBattlerAttacker].recursionCounter++;
                }
            }
            else
            {
                gDisableStructs[gBattlerAttacker].recursionCounter = 0;
            }
        }
        break;
...
u8 ItemBattleEffects(u8 caseID, u32 battler, bool32 moveTurn)
{
    ...
    case ITEMEFFECT_LIFEORB_SHELLBELL:
        ...
        case HOLD_EFFECT_THROAT_SPRAY:  // Does NOT need to be a damaging move
            ...
            break;
        case HOLD_EFFECT_SHRINK_RAY:  // needs to damage the foe, will add the 30% chance later
            if (gSpecialStatuses[gBattlerAttacker].damagedMons
             && gBattleMons[gBattlerTarget].hp != 0
             && gBattlerAttacker != gBattlerTarget
             && !(gStatuses3[gBattlerTarget] & STATUS3_MINIMIZED)
             && RandomPercentage(RNG_FICKLE_BEAM, 30)
             )
            {
                gLastUsedItem = atkItem;
                gStatuses3[gBattlerTarget] |= STATUS3_MINIMIZED;
                effect = ITEM_EFFECT_OTHER;
                BattleScriptPushCursor();
                gBattlescriptCurrInstr = BattleScript_ItemMinimizeTarget;
            }
            break;
        }
        break;
        ...
        if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
        {
            ...
            case HOLD_EFFECT_AIR_BALLOON:
                if (TARGET_TURN_DAMAGED)
                {
                    effect = ITEM_EFFECT_OTHER;
                    BattleScriptPushCursor();
                    gBattlescriptCurrInstr = BattleScript_SoulLocketMsgBreak;
                }
                break;
            case HOLD_EFFECT_SOUL_LOCKET:
                if (TARGET_TURN_DAMAGED)
                {
                    effect = ITEM_EFFECT_OTHER;
                    BattleScriptPushCursor();
            ...
            case HOLD_EFFECT_DEVIL_LOCKET:
                if (TARGET_TURN_DAMAGED)
                {
                    ...
                    effect = ITEM_HP_CHANGE;
                    BattleScriptPushCursor();
                    gBattlescriptCurrInstr = BattleScript_DevilLocketMsgBreak;
                    PREPARE_ITEM_BUFFER(gBattleTextBuff1, gLastUsedItem);
                    RecordItemEffectBattle(battler, HOLD_EFFECT_DEVIL_LOCKET);
                }
                break;
...
u32 GetMoveTarget(u16 move, u8 setTarget)
{
    ...
    case MOVE_TARGET_SELECTED:
        ...
        else
        {
            ...
            else if (gMovesInfo[move].type == TYPE_FIRE
            ...
            else if (gMovesInfo[move].type == TYPE_BUG
                && IsAbilityOnOpposingSide(gBattlerAttacker, ABILITY_FLYTRAP)
                && GetBattlerAbility(targetBattler) != ABILITY_FLYTRAP)
            {
                targetBattler ^= BIT_FLANK;
                RecordAbilityBattle(targetBattler, gBattleMons[targetBattler].ability);
                gSpecialStatuses[targetBattler].flytrapRedirected = TRUE;
            }
        }
        break;
...
{
    if(gBattleMons[battler].hp > (gBattleMons[battler].maxHP - ((gBattleMons[battler].maxHP*9)/10)))
        return TRUE;
    else
        return FALSE;
}
...
u32 GetBattlerHeight(u32 battler)
{
    ...
    if(gStatuses3[battler] & STATUS3_MINIMIZED)
    {
        height *= 0.5;
    }
...
u32 CountSpecificStatBoosts(u32 battler, u32 stat)
{
    u32 count = 0;

    if (gBattleMons[battler].statStages[stat] > DEFAULT_STAT_STAGE) // Stat is increased.
...
static inline u32 CalcMoveBasePower(u32 move, u32 battlerAtk, u32 battlerDef, u32 abilityDef, u32 weather)
{
    ...
    case EFFECT_BARRIER_CRASH:
        if( (gSideStatuses[GetBattlerSide(battlerAtk)] & SIDE_STATUS_REFLECT) || (gSideStatuses[GetBattlerSide(battlerDef)] & SIDE_STATUS_REFLECT))
        {
            basePower += 20;
        }
        if( (gSideStatuses[GetBattlerSide(battlerAtk)] & SIDE_STATUS_LIGHTSCREEN) || (gSideStatuses[GetBattlerSide(battlerDef)] & SIDE_STATUS_LIGHTSCREEN))
        {
            basePower += 20;
        }
        if( (gSideStatuses[GetBattlerSide(battlerAtk)] & SIDE_STATUS_AURORA_VEIL) || (gSideStatuses[GetBattlerSide(battlerDef)] & SIDE_STATUS_AURORA_VEIL))
        {
            basePower += 20;
        }
        break;
    ...
    case EFFECT_ECHOED_VOICE:
        ...
        break;
    case EFFECT_REVERBERATE:
        if(gProtectStructs[gBattlerTarget].usedSoundMove || (IsDoubleBattle() && (gProtectStructs[BATTLE_PARTNER(gBattlerAttacker)].usedSoundMove || gProtectStructs[BATTLE_PARTNER(gBattlerTarget)].usedSoundMove)) )
        {
            basePower *= 3/2;
        }
    case EFFECT_PAYBACK:
    ...
    case EFFECT_LASH_OUT:
        if(CountBattlerStatDrops(battlerAtk, TRUE) > 0)
            basePower *= 2;
        break;
    ...
    case EFFECT_FALSE_SWIPE:
        {
            ...
            {
                basePower += (((gBattleMons[battlerAtk].level / 10) * 10) - 10);
                if(basePower > 90)
                {
                    basePower = 90;
                }
...
u32 CalcMoveBasePowerAfterModifiers(u32 move, u32 battlerAtk, u32 battlerDef, u32 moveType, bool32 updateFlags, u32 atkAbility, u32 defAbility, u32 holdEffectAtk, u32 weather)
{
    ...
    case EFFECT_BULLDOZE:
        if (gFieldStatuses & STATUS_FIELD_TERRAIN_ANY && !(gStatuses3[battlerDef] & STATUS3_SEMI_INVULNERABLE))
    ...
    if (gStatuses3[battlerAtk] & STATUS3_CHARGED_UP && moveType == TYPE_ELECTRIC)
        {
            modifier = uq4_12_multiply(modifier, UQ_4_12(2.0));
            /*
            gDisableStructs[battlerAtk].chargeTimer -= 1;
            if (gDisableStructs[battlerAtk].chargeTimer == 0)
            {
    ...
    */
    ...
    case ABILITY_TWINDRILL:
        if(gMovesInfo[move].piercingMove)
           modifier = uq4_12_multiply(modifier, UQ_4_12(1.3));
        break;
    case ABILITY_SUPREME_OVERLORD:
        ...
        break;
    case ABILITY_RECURSION:
        modifier = uq4_12_multiply(modifier, GetRecursionModifier(battlerAtk));
    case ABILITY_BEFUDDLING:
        if( !(gProtectStructs[battlerAtk].confusionSelfDmg) && gBattleMons[battlerAtk].status2 & STATUS2_CONFUSION)
           modifier = uq4_12_multiply(modifier, UQ_4_12(1.5));
    }
...
static inline u32 CalcAttackStat(u32 move, u32 battlerAtk, u32 battlerDef, u32 moveType, bool32 isCrit, bool32 updateFlags, u32 atkAbility, u32 defAbility, u32 holdEffectAtk)
{
    ...
    else if ( (gMovesInfo[move].effect == EFFECT_BODY_PRESS) || (move == MOVE_SKULL_BASH))
    {
    ...
    */
    ...
    // critical hits, lash out, and punching moves with iron fist ignore attack stat's stage drops
    if ((isCrit || move == MOVE_LASH_OUT || (atkAbility == ABILITY_IRON_FIST && gMovesInfo[move].punchingMove)) && atkStage < DEFAULT_STAT_STAGE)
        atkStage = DEFAULT_STAT_STAGE;
    // apathy ignores the user's stat changes period, dulled ignores the user's stat buffs
    if(atkAbility == ABILITY_APATHY || (atkAbility == ABILITY_DULLED && atkStage > DEFAULT_STAT_STAGE))
        atkStage = DEFAULT_STAT_STAGE;
    ...
    case ABILITY_THICK_FAT:
        ...
        break;
    case ABILITY_RATIONALE:
        if (moveType == TYPE_GHOST || moveType == TYPE_FAIRY || moveType == TYPE_DRAGON)
        {
            modifier = uq4_12_multiply_half_down(modifier, UQ_4_12(0.5));
            if (updateFlags)
                RecordAbilityBattle(battlerDef, ABILITY_RATIONALE);
        }
        break;
    case ABILITY_SLUDGE_BODY:
        if (moveType == TYPE_FAIRY)
        {
            modifier = uq4_12_multiply_half_down(modifier, UQ_4_12(0.5));
            if (updateFlags)
                RecordAbilityBattle(battlerDef, ABILITY_SLUDGE_BODY);
        }
        break;
    }
...
static inline u32 CalcDefenseStat(u32 move, u32 battlerAtk, u32 battlerDef, u32 moveType, bool32 isCrit, bool32 updateFlags, u32 atkAbility, u32 defAbility, u32 holdEffectDef, u32 weather)
{
    ...
    // apathy ignores all stat changes, dulled ignores all stat boosts
    if (defAbility == ABILITY_APATHY || (defAbility == ABILITY_DULLED && defStage > DEFAULT_STAT_STAGE))
        defStage = DEFAULT_STAT_STAGE;
    ...
    if ((defAbility == ABILITY_MINUS
        || (defAbility == ABILITY_PLUS && GetBattlerAbility(BATTLE_PARTNER(battlerDef)) == ABILITY_MINUS))
        && gStatuses3[battlerDef] & STATUS3_CHARGED_UP)
        {
            modifier = uq4_12_multiply_half_down(modifier, UQ_4_12(1.3));
        }
    ...
    case HOLD_EFFECT_ASSAULT_VEST:
        ...
        break;
    case HOLD_EFFECT_SOUL_LOCKET:
        modifier = uq4_12_multiply_half_down(modifier, UQ_4_12(4));
        break;
    case HOLD_EFFECT_DEVIL_LOCKET:
        modifier = uq4_12_multiply_half_down(modifier, UQ_4_12(1.43));
        break;
    case HOLD_EFFECT_SOUL_DEW:
    ...
    if (IS_BATTLER_OF_TYPE(battlerDef, TYPE_ICE) && IsBattlerWeatherAffected(battlerDef, B_WEATHER_HAIL) && usesDefStat)
        modifier = uq4_12_multiply_half_down(modifier, UQ_4_12(1.5));
    if(gSideStatuses[battlerDef] & SIDE_STATUS_MIST &&
    (CalcTypeEffectivenessMultiplier(move, gMovesInfo[move].type, battlerAtk, battlerDef, GetBattlerAbility(battlerDef), FALSE) >= UQ_4_12(2.0)))
...
static inline uq4_12_t GetSameTypeAttackBonusModifier(u32 battlerAtk, u32 moveType, u32 move, u32 abilityAtk)
{
    if (gBattleStruct->pledgeMove && IS_BATTLER_OF_TYPE(BATTLE_PARTNER(battlerAtk), moveType))
        return (abilityAtk == ABILITY_ADAPTABILITY) ? UQ_4_12(2.0) : UQ_4_12(1.35);
...
static uq4_12_t GetWeatherDamageModifier(u32 battlerAtk, u32 move, u32 moveType, u32 holdEffectAtk, u32 holdEffectDef, u32 weather)
{
    ...
    if (gMovesInfo[move].effect == EFFECT_HYDRO_STEAM
        && ((weather & B_WEATHER_SUN) || (move == MOVE_OIL_FIRE && (weather & B_WEATHER_RAIN)))
...
static inline uq4_12_t GetCriticalModifier(bool32 isCrit)
{
    if (isCrit)
    {
        if ((GetBattlerAbility(gBattlerAttacker) == ABILITY_SHARPNESS) && (gMovesInfo[gCurrentMove].slicingMove))
            return UQ_4_12(2.0);
        else
            return UQ_4_12(1.5);
    }
...
{
    if ( (gMovesInfo[move].minimizeDoubleDamage || gMovesInfo[move].curlBoosted) && gStatuses3[battlerDef] & STATUS3_MINIMIZED)
        return UQ_4_12(2.0);
    return UQ_4_12(1.0);
}
...
static inline uq4_12_t GetScreensModifier(u32 move, u32 battlerAtk, u32 battlerDef, bool32 isCrit, u32 abilityAtk)
{
    ...
    bool32 wideGuard = sideStatus & SIDE_STATUS_WIDE_GUARD;
    bool32 quickGuard = sideStatus & SIDE_STATUS_QUICK_GUARD;
    ...
    if ((wideGuard || quickGuard) && !(reflect || lightScreen || auroraVeil))
        return UQ_4_12(0.9);
    return UQ_4_12(1.0);
}
...
static inline void MulByTypeEffectiveness(uq4_12_t *modifier, u32 move, u32 moveType, u32 battlerDef, u32 defType, u32 battlerAtk, bool32 recordAbilities)
{
    ...
    if (gMovesInfo[move].effect == EFFECT_FALSE_SWIPE && defType == TYPE_GHOST && mod == UQ_4_12(0.0))
        mod = UQ_4_12(1.0);
    if(gMovesInfo[move].effect == EFFECT_SYNCHRONOISE)
    {
...
static inline uq4_12_t CalcTypeEffectivenessMultiplierInternal(u32 move, u32 moveType, u32 battlerAtk, u32 battlerDef, bool32 recordAbilities, uq4_12_t modifier, u32 defAbility)
{
    ...
    {
        if ( (gBattleMons[battlerDef].type1 == TYPE_POISON || gBattleMons[battlerDef].type2 == TYPE_POISON || gBattleMons[battlerDef].type3 == TYPE_POISON)
    ...
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (B_RESTORE_HELD_BATTLE_ITEMS == TRUE || gBattleStruct->itemLost[i].stolen)
        {
            ...
            if (lostItem != ITEM_NONE
                ...
                SetMonData(&gPlayerParty[i], MON_DATA_HELD_ITEM, &lostItem);  // Restore stolen/consumed non-berry items
        }
    }
}
...
u32 CalcSecondaryEffectChance(u32 battler, u32 battlerAbility, const struct AdditionalEffect *additionalEffect)
{
    ...
    if (hasRainbow && additionalEffect->moveEffect != MOVE_EFFECT_SECRET_POWER)
        secondaryEffectChance *= 2;
    //burn chance is boosted by 50% in sun, and halved in hail and rain
    ...
    if ( additionalEffect->moveEffect == MOVE_EFFECT_FREEZE || additionalEffect->moveEffect == MOVE_EFFECT_FROSTBITE )
    {
        if (gBattleWeather & B_WEATHER_SUN)
        {
            secondaryEffectChance *= 0.75;
        }
        if (gBattleWeather & B_WEATHER_HAIL && !(additionalEffect->onlyInHail))
        {
            secondaryEffectChance *= 1.25;
        }
    }

    if(gCurrentMove == MOVE_ZERO_DEGREE_BULLETS && additionalEffect->moveEffect == MOVE_EFFECT_FREEZE 
        && (gBattleWeather & B_WEATHER_HAIL))
    {
...
void CosmicAuraAllyBoost(u32 battler, u8 stat)
{
    if (CompareStat(battler, stat, MAX_STAT_STAGE, CMP_LESS_THAN))
    {
        BufferStatChange(battler, stat, STRINGID_STATROSE);
        gEffectBattler = battler;
        SET_STATCHANGER(stat, 1, FALSE);
